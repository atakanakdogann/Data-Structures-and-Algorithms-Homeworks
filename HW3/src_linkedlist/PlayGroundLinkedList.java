...
public class PlayGroundLinkedList implements basicInterface{
    //PlayGround Array
    private int[][] arr;
    // Building Array. I decided maximum 10 building for street
    private LinkedList<Buildings> buildings = new LinkedList<Buildings>();
    ...
    public PlayGroundLinkedList(){

    }
    //User selected size for street
    public PlayGroundLinkedList(int str_sz){
        street_size = str_sz;
    }
    ...
    public void driverMethod(){
        ...
        buildings.get(buildingCount).setLength(8); buildings.get(buildingCount).setHeight(17);
        buildings.get(buildingCount).setOwner("Ahmet Akdogan");    buildings.get(buildingCount).setColor("Grey"); buildings.get(buildingCount).setRoomNumber(5);
        ...
        buildings.get(buildingCount).setSide(1);    buildings.get(buildingCount).setPosition(10);
        buildings.get(buildingCount).setLength(14); buildings.get(buildingCount).setHeight(11);
        ...
        buildings.get(buildingCount).setLength(10); buildings.get(buildingCount).setHeight(15);
        buildings.get(buildingCount).setOwner("Our Market");    buildings.get(buildingCount).setJobTimes("08.30", "22.00");
        for(int i = 30 - buildings.get(buildingCount).getHeight(); i < 30; i++){
            for(int j = buildings.get(buildingCount).getPosition()-(buildings.get(buildingCount).getLength()/2); j < buildings.get(buildingCount).getPosition()+(buildings.get(buildingCount).getLength()/2); j++){
                if(arr[i][j] == 1){
                    arr[i][j] = 3;
